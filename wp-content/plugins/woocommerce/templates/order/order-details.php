...
?>
<h2 class="checkout-header"><?php _e( 'Enquiry Details', 'woocommerce' ); ?></h2>
...
<header>
	<h2 class="checkout-header"><?php _e( 'Customer details', 'woocommerce' ); ?></h2>
</header>
...
<?php endif; ?>
		...
		<header class="title">
			<h3 class="checkout-header"><?php _e( 'Customer Address', 'woocommerce' ); ?></h3>
		</header>
		<address>
			<?php
